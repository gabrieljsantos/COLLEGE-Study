...
struct cliente {
    ...
    char nome[30];
    double saldo;
    // Definição de uma struct para lidar com contas bancarias.
    // numero provavelmente é o id,  um vertor de char, com tamanho 30, para armazenar o nome
    // e por fim a variavel do saldo, do tipo double, para armazenar casas decimais.
};
````
